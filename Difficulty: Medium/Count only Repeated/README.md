<h2><a href="https://www.geeksforgeeks.org/problems/count-only-repeated2047/1?page=3&category=Searching&sortBy=submissions">Count only Repeated</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;"><span style="font-size: 18px;">Given a sorted array <strong>arr[]</strong> of positive integers where the elements are <strong>consecutive</strong>, meaning the difference between adjacent distinct elements is exactly 1. In the array, <strong>exactly one element is repeated one or more times</strong>, while all other elements appear exactly once.</span></span></p>
